...
{
  "implementation_id", "AccelerationControl",
  "type_name",         "AccelerationControl",
 ...
 */
AccelerationControl::AccelerationControl(RTC::Manager* manager)
// <rtc-template block="initializer">
    ...
    // </rtc-template>
{
    AccelerationControl::m_accel = 0.0;
    AccelerationControl::m_maxSpeed = 0.0;
}
...
RTC::ReturnCode_t AccelerationControl::onInitialize()
{
    ...
    bindParameter("maxSpeed", m_maxSpeed, "15.0");
    // </rtc-template>
...
/*
RTC::ReturnCode_t AccelerationControl::onFinalize()
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t AccelerationControl::onStartup(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t AccelerationControl::onShutdown(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
RTC::ReturnCode_t AccelerationControl::onActivated(RTC::UniqueId ec_id)
{
    while (1) {
...
RTC::ReturnCode_t AccelerationControl::onDeactivated(RTC::UniqueId ec_id)
{
    return RTC::RTC_OK;
}


RTC::ReturnCode_t AccelerationControl::onExecute(RTC::UniqueId ec_id)
{
...
/*
RTC::ReturnCode_t AccelerationControl::onAborting(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t AccelerationControl::onError(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t AccelerationControl::onReset(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t AccelerationControl::onStateUpdate(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t AccelerationControl::onRateChanged(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
extern "C"
{
    ...
    void AccelerationControlInit(RTC::Manager* manager)
    {
        coil::Properties profile(accelerationcontrol_spec);
        manager->registerFactory(profile,
            RTC::Create<AccelerationControl>,
            RTC::Delete<AccelerationControl>);
    }
